    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PalestrantesEvents", x => new { x.EventId, x.PalestranteId });
                    table.ForeignKey(
                        name: "FK_PalestrantesEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PalestrantesEvents_Palestrantes_PalestranteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RedeSociais_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PalestrantesEvents_PalestranteId",
                table: "PalestrantesEvents",
                column: "PalestranteId");

            migrationBuilder.CreateIndex(
                name: "IX_RedeSociais_EventId",
                table: "RedeSociais",
                column: "EventId");
